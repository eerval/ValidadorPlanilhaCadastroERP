...
// ✅ NOVA FUNÇÃO: Remover linhas completamente vazias
function removeEmptyRows(data) {
    return data.filter(row => {
        // Verifica se pelo menos uma célula tem valor (ignora _rowIndex)
        return Object.entries(row)
            .filter(([key]) => key !== '_rowIndex') // ignora propriedade interna
            .some(([, value]) => {
...
self.onmessage = function(e) {
    ...
    if (action === 'PROCESS_FILE') {
        ...
        try {
            ...
            // ✅ MELHORIA: Filtrar linhas vazias usando a função removeEmptyRows
            ...
            self.postMessage({ 
                ...
                removedEmptyRows: removedRowCount // ✅ ENVIA INFO SOBRE LINHAS REMOVIDAS
            });
